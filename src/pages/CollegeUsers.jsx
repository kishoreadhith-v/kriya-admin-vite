...
const CollegeUsers = () => {
  ...
  useEffect(() => {
    toast.promise(fetchCollegeStats(), {
      loading: "Loading college statistics...",
      success: (res) => {
  ...
  return (
    <Layout title={"College Wise Registrations"}>
      <div className="flex flex-col lg:flex-row space-y-2 lg:space-y-0 w-full justify-around items-center pb-12">
        ...
        <button
          className={`px-6 py-2 rounded-full ${
            paidFilter ? "bg-[#3c3c3c] text-white" : "bg-[#eaeaea] text-[#303030]"
        ...
        <button
          className={`px-6 py-2 rounded-full ${
            allFilter ? "bg-[#3c3c3c] text-white" : "bg-[#eaeaea] text-[#303030]"
          } border-2 border-[#303030]`}
          onClick={() => {
            setPaidFilter(false);
            setAllFilter(true);
      ...
      <div className="flex flex-col lg:flex-row space-y-2 lg:space-y-0 w-full justify-around items-center pb-12">
        ...
        <button
          className={`px-6 py-2 rounded-full ${
            alphabetically ? "bg-[#3c3c3c] text-white" : "bg-[#eaeaea] text-[#303030]"
          } border-2 border-[#303030]`}
          onClick={() => {
        ...
        <button
          className={`px-6 py-2 rounded-full ${
            registrations ? "bg-[#3c3c3c] text-white" : "bg-[#eaeaea] text-[#303030]"
          } border-2 border-[#303030]`}
          onClick={() => {
