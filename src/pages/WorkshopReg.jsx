  ...
  return (
    <Layout title={"Workshop Registrations"}>
      <div className="flex flex-col lg:flex-row space-y-2 lg:space-y-0 w-full justify-around items-center pb-12">
        ...
        <button
          className={`px-6 py-2 rounded-full ${workID ? "bg-[#3c3c3c] text-white" : "bg-[#eaeaea] text-[#303030]"} border-2 border-[#303030]`}
          onClick={() => {
            setWorkID(true);
        ...
        <button
          className={`px-6 py-2 rounded-full ${registrations ? "bg-[#3c3c3c] text-white" : "bg-[#eaeaea] text-[#303030]"} border-2 border-[#303030]`}
          onClick={() => {
            setWorkID(false);
        ...
        <button
          className={`hidden lg:block px-6 py-2 rounded-full ${percentage ? "bg-[#3c3c3c] text-white" : "bg-[#eaeaea] text-[#303030]"} border-2 border-[#303030]`}
          onClick={() => {
            setWorkID(false);
            setRegistrations(false);
            setPercentage(true);
